 ...
 * @author Jakob Frank
 * @author Rudolf Mayer
 * @version $Id: VisualisationImageSaver.java 4280 2013-05-02 20:55:29Z mayer $
 */
public class VisualisationImageSaver implements SOMToolboxApp {
    ...
    public static void main(String[] args) {
        ...
        String uFile = AbstractOptionFactory.getFilePath(res, "unitDescriptionFile");
        String wFile = AbstractOptionFactory.getFilePath(res, "weightVectorFile");
        String dwmFile = AbstractOptionFactory.getFilePath(res, "dataWinnerMappingFile");
        String cFile = AbstractOptionFactory.getFilePath(res, "classInformationFile");
        String vFile = AbstractOptionFactory.getFilePath(res, "inputVectorFile");
        String tFile = AbstractOptionFactory.getFilePath(res, "templateVectorFile");
