...
/**
 * This class collects options (re-)used in various SOMToolbox applications; register your new options here,
...
public class OptionFactory extends AbstractOptionFactory {
    ...
    public static String[] matchModeStrings;
    static {
        MatchMode[] values = MatchMode.values();
        matchModeStrings = new String[values.length];
        for (int i = 0; i < matchModeStrings.length; i++) {
            matchModeStrings[i] = values[i].toString();
        }
    }
    ...
    public static FileStringParser getClassFileParser() {
        return getInputFileParser("cls", "clsinf", "clsinfo", "classinfo", "txt");
    }
    ...
    public static FlaggedOption getOptClassInformationFile(boolean required) {
        return new FlaggedOption("classInformationFile", getClassFileParser(), null, required, 'c', JSAP.NO_LONGFLAG,
    ...
    public static FlaggedOption getOptClasslist(boolean required) {
        return new FlaggedOption("classList", JSAP.STRING_PARSER, null, required, JSAP.NO_SHORTFLAG, "classlist",
                "A List of class names").setList(true).setListSeparator(':');
    }
    ...
    public static FlaggedOption getOptSetSecondSOM(boolean required) {
        return new FlaggedOption("secondSOMPrefix", getInputFileParser("unit", "unit.gz", "wgt", "wgt.gz", "dwm",
                "dwm.gz", "map", "map.gz"), null, required, '2', "secondSOM",
    ...
    public static FlaggedOption getOptImagePrefix() {
        return new FlaggedOption("imagePrefix", JSAP.STRING_PARSER, null, false, JSAP.NO_SHORTFLAG, "imagePrefix",
                "Prefix to prepend to the labels to find the images");
    }

    public static FlaggedOption getOptImageSuffix() {
        return new FlaggedOption("imageSuffix", JSAP.STRING_PARSER, null, false, JSAP.NO_SHORTFLAG, "imageSuffix",
    ...
    public static FlaggedOption getOptMatchMode(boolean required, String[] validOptionValues, String defaultValue) {
        return new FlaggedOption("matchMode", makeEnumeratedStringParser(validOptionValues), defaultValue, required,
                JSAP.NO_SHORTFLAG, "matchMode", "Match mode: " + Arrays.toString(validOptionValues));
    }

    public static FlaggedOption getOptMatchMode(boolean required) {
        return getOptMatchMode(required, matchModeStrings, MatchMode.exact.toString());
    }
    ...
    public static FlaggedOption getOptMetric(boolean required, String defaultMetric) {
        return new FlaggedOption("metric", JSAP.STRING_PARSER, defaultMetric, required, JSAP.NO_SHORTFLAG, "metric",
                "Name of the metric to be used for distance calculation in input space.");
    }

    public static FlaggedOption getOptMetric(boolean required) {
        return getOptMetric(required, L2Metric.class.getName());
    }
    ...
    public static FlaggedOption getOptNumberItems(boolean required) {
        return new FlaggedOption("numberItems", JSAP.INTEGER_PARSER, null, required, JSAP.NO_SHORTFLAG, "numberItems",
                "Number of items");
    }
    ...
    public static FlaggedOption getOptNumberNeighbours(boolean required) {
        return getOptNumberNeighbours(required, null);
    }

    public static FlaggedOption getOptNumberNeighbours(boolean required, String defaultValue) {
        return new FlaggedOption("numberNeighbours", JSAP.INTEGER_PARSER, defaultValue, required, 'n',
                "numberNeighbours", "Number of neighbours to find.");
    }
    ...
    public static FlaggedOption getOptRandomSeed(boolean required) {
        return new FlaggedOption("randomSeed", JSAP.INTEGER_PARSER, null, required, JSAP.NO_SHORTFLAG, "randomSeed",
    ...
    public static FlaggedOption getOptStrip(boolean required) {
        return new FlaggedOption("stripFromString", JSAP.STRING_PARSER, null, required, JSAP.NO_SHORTFLAG, "strip",
    ...
    public static FlaggedOption getOptSort(boolean required) {
        return new FlaggedOption("sort", JSAP.BOOLEAN_PARSER, null, required, JSAP.NO_SHORTFLAG, "sort", "");
    }
    ...
    public static Switch getSwitchOnlyLastPathSegment(boolean required) {
        return new Switch("onlyLastPathSegment", JSAP.NO_SHORTFLAG, "onlyLastPathSegment",
                "Use only the last path segement, i.e. everything after the last /.");
    }
