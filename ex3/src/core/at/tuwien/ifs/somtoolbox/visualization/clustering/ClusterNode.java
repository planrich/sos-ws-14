...
import at.tuwien.ifs.somtoolbox.clustering.TwoDimensionalClusterShapeStats;
 ...
 * @version $Id: ClusterNode.java 4202 2011-03-28 16:21:18Z mayer $
 */
public class ClusterNode implements Serializable {
    ...
    public TwoDimensionalClusterShapeStats getClusterShapeStats() {
        TwoDimensionalClusterShapeStats stats = new TwoDimensionalClusterShapeStats();
        for (GeneralUnitPNode unitNode : unitNodes) {
            Unit unit = unitNode.getUnit();
            stats.addPoint(unit.getXPos(), unit.getYPos());
        }
        return stats;
    }
    ...
    public String toString() {
        ...
        for (GeneralUnitPNode element : unitNodes) {
            if (sb.length() > 0) {
