...
/**
 * @author Rudolf Mayer
 * @version $Id: FuzzyColourCodingVisualiser.java 4161 2011-02-11 16:23:39Z mayer $
 */
public class FuzzyColourCodingVisualiser extends AbstractBackgroundImageVisualizer {
    ...
    protected String getVisualisationSpecificCacheKey(int currentVariant) {
        return buildCacheKey("T:" + T, "r:" + r, "colorCoding:" + showColourCoding, "showUnits:" + showUnitNodes,
                "showConnections:" + showConnectingLines);
    }
