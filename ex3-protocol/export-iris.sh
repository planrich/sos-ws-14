...
function e() {
    ...
    bash som.sh iris-hex iris "--vis $VIS -e $PDIR/iris-$ID-hex.png"
    bash som.sh iris iris "--vis $VIS -e $PDIR/iris-$ID.png "
}
...
function ep() {
    ...
    bash som.sh iris-hex iris "--vis $VIS --visParams $PARAM -e $PDIR/cl-$ID-hex.png"
    bash som.sh iris iris "--vis $VIS --visParams $PARAM -e $PDIR/cl-$ID.png"
}
